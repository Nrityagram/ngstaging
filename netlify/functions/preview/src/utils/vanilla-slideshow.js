...
var vanillaSlideshow = (function () {
  ...
  var slides = document
    .getElementById("vanilla-slideshow")
    .getElementsByClassName("vanilla-slide");
  ...
  // var metaDataElem, metaDataInfo;

  // Set image credit depending on the responsive image
  // function _setmetaData(elem, metaDataInfo) {
  //   if (window.innerWidth > 1024) {
  //     elem.innerHTML = metaDataInfo.metadataDesk;
  //   } else if (window.innerWidth > 599) {
  //     elem.innerHTML = metaDataInfo.metadataTablet;
  //   } else {
  //     elem.innerHTML = metaDataInfo.metadataMobile;
  //   }
  // }
  ...
  function _checkProperties() {
    ...
    for (var i = 0; i < slides.length; i++) {
      ...
      if (i === random) {
        ...
        //   _setmetaData(metaDataElem, metaDataInfo);
        // }
      }
  ...
  function _slideShow() {
    ...
    // metaDataInfo = next.childNodes[3].dataset;
    // metaDataInfo = next.querySelector(".meta-data").dataset;
    // metaDataElem = next.querySelector(".meta-data");
    // if (Object.keys(metaDataInfo).length) {
    //   _setmetaData(metaDataElem, metaDataInfo);
    // }
    ...
    if (defaults.indicators) {
      var activePointer = document.querySelector(
        "#" + indicatorsContainer + " .vanilla-active"
      );
  ...
  function _previousSlide() {
    ...
    // metaDataInfo = previous.querySelector(".meta-data").dataset;
    // metaDataElem = previous.querySelector(".meta-data");
    // if (Object.keys(metaDataInfo).length) {
    //   _setmetaData(metaDataElem, metaDataInfo);
    // }
  ...
  function _createIndicators() {
    ...
    app.indicators = slideshowContainer.getElementsByClassName(
      indicatorsContainer
    );
  }
  ...
  app.init = function (arguments) {
    ...
    if (arguments && typeof arguments === "object") {
      defaults.arrows =
        arguments.arrows !== "" ? arguments.arrows : defaults.arrows;
      defaults.indicators =
        arguments.indicators !== ""
          ? arguments.indicators
          : defaults.indicators;
      defaults.random =
        arguments.random !== "" ? arguments.random : defaults.random;
      defaults.slideshow =
        arguments.slideshow !== "" ? arguments.slideshow : defaults.slideshow;
      defaults.delay = arguments.delay ? arguments.delay : defaults.delay;
      defaults.animationSpeed = arguments.animationSpeed
        ? arguments.animationSpeed
